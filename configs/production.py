...
SECRET_KEY = os.getenv('SECRET_KEY', 'e951e5a1f4b94151b360f47edf596dd2')
BIND_ADDRESS = os.getenv('BIND_ADDRESS','0.0.0.0')
PORT = os.getenv('PORT', 9191)
SERVER_EXTERNAL_SSL = os.getenv('SERVER_EXTERNAL_SSL', None)

### DATABASE CONFIG
SQLA_DB_USER = os.getenv('DB_USER', 'pda')
SQLA_DB_PASSWORD = os.getenv('DB_PASSWORD','changeme')
SQLA_DB_HOST = os.getenv('DB_HOST','127.0.0.1')
SQLA_DB_NAME = os.getenv('DB_NAME','pda')
